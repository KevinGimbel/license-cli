...
export const UPL_1_0: License = {
  ...
  "using": [
    {
      "Oracle Product Boxes for Vagrant":
        "https://github.com/oracle/vagrant-boxes/blob/master/LICENSE",
    },
    {
      "Oracle Product Images for Docker":
